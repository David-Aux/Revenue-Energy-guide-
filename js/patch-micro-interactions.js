...
(function () {
  ...
  if (!document.getElementById('eg-ripple-style')) {
    ...
    s.textContent = `
      ...
      .toast { animation:egToastIn 0.25s cubic-bezier(0.4,0,0.2,1) !important; }
      ...
      /* Screen enter animation — staggered children */
      .screen.active > * {
        animation: egFadeUp 0.3s cubic-bezier(0.4,0,0.2,1) both;
      }
      ...
      .screen.active > *:nth-child(4) { animation-delay:0.10s; }
      .screen.active > *:nth-child(5) { animation-delay:0.13s; }
      .screen.active > *:nth-child(6) { animation-delay:0.15s; }
      @keyframes egFadeUp {
      ...
      .stat-card [id$="Count"] {
        animation:egStatPop 0.5s cubic-bezier(0.4,0,0.2,1) both;
