    ...
    function egTeamInstallerCard(state) {
      const waLink = 'https://wa.me/2348142472213?text=' + encodeURIComponent('Hello EnergyGuide Team, I need a solar installation in ' + (state || 'my state') + '. Please assist.');
      const mailLink = 'mailto:energyguideng@outlook.com?subject=' + encodeURIComponent('Solar Installation Request – ' + (state || '')) + '&body=' + encodeURIComponent('Hello,\n\nI need a solar installation in ' + (state || 'my state') + '. Please assist.\n\nThank you.');
      return `
        <div class="result-card" style="text-align:left; margin-bottom:14px; border-left:4px solid #22C55E;">
          <div class="result-label">Verified Installer</div>
          <div class="result-value" style="font-size:22px; margin-bottom:8px;">⚡ EnergyGuide Installation Team</div>
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; font-size:14px; line-height:1.5;">
            <div><span style="color:#687076;">Coverage</span><br><strong>${state ? state + ' State' : 'Nationwide'}</strong></div>
            <div><span style="color:#687076;">Status</span><br><strong style="color:#22C55E;">✅ Available</strong></div>
            <div><span style="color:#687076;">Phone / WhatsApp</span><br><strong>+234 814 247 2213</strong></div>
            <div><span style="color:#687076;">Email</span><br><strong>energyguideng@outlook.com</strong></div>
            <div style="grid-column:1/-1;"><span style="color:#687076;">About</span><br><strong>Our in-house team handles installations while we onboard local installers in your state. Reach out directly to get started.</strong></div>
          </div>
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-top:14px;">
            <a href="${mailLink}" class="btn btn-outline" style="text-align:center; text-decoration:none; display:flex; align-items:center; justify-content:center;">✉️ Email Us</a>
            <a href="${waLink}" target="_blank" class="btn btn-success" style="text-align:center; text-decoration:none; display:flex; align-items:center; justify-content:center;">💬 WhatsApp</a>
          </div>
        </div>`;
    }
    ...
    async function loadInstallerMarketplace() {
      ...
      try {
        ...
        // No installers onboarded yet — show EnergyGuide Team fallback
