    ...
    async function egLoadVendorProductsInline(vendorId) {
      ...
      try {
        ...
        function buildProductCard(p) {
          ...
          return `
            <div onclick="egShowProductDetail('${vendorId}','${p.id}',${JSON.stringify(JSON.stringify(p))})"
              style="display:flex;gap:10px;align-items:flex-start;padding:10px 0;
                     border-bottom:1px solid #f3f4f6;cursor:pointer;
                     transition:background 0.15s;" 
              onmousedown="this.style.background='#f9fafb'" 
              ...
              <div style="text-align:right;flex-shrink:0;margin-left:8px;">
                ...
                <div style="font-size:11px;color:#9ca3af;margin-top:2px;">Tap →</div>
              </div>
            </div>`;
        }
    ...
    function egShowProductDetail(vendorId, productId, productJsonStr) {
      let p;
      try { p = JSON.parse(productJsonStr); } catch(e) { return; }
      ...
      egShowModal(`
        <div>
          ...
          <button onclick="egRemoveModal(); openProductEnquiry('${vendorId}','${productId}',${JSON.stringify(nameSafe)})"
