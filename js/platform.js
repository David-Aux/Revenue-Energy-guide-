// EG-VERSION: v304-fix
    ...
    // Stashes load data so calc-ci.js can pre-fill and auto-run on arrival.
    window.egCIHandoff = function(peakKw, dailyKwh) {
      try { sessionStorage.setItem('eg_ci_handoff', JSON.stringify({peakKw:+peakKw, dailyKwh:+dailyKwh})); } catch(e) {}
      ...
      // Dispatch event so calc-ci.js can pick up the handoff after screen transition
