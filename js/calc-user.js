  ...
  function l4u__renderResults(s){
    ...
    if(summaryEl){
      summaryEl.innerHTML =
        '<div style="background:linear-gradient(135deg,rgba(245,158,11,0.12),rgba(245,158,11,0.04));border:1px solid var(--sun,#f59e0b);border-radius:14px;padding:18px;margin-bottom:4px;">'+
        '<div style="font-size:11px;text-transform:uppercase;letter-spacing:1px;color:var(--sun,#f59e0b);font-weight:700;margin-bottom:12px;">✅ Your Solar Recommendation</div>'+
        '<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;">'+
          '<div style="background:rgba(255,255,255,0.05);border-radius:10px;padding:12px;">'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);margin-bottom:4px;">SOLAR POWER UNIT</div>'+
            '<div style="font-size:15px;font-weight:800;color:var(--text,#f1f5f9);">'+friendlyInv+'</div>'+
          '</div>'+
          '<div style="background:rgba(255,255,255,0.05);border-radius:10px;padding:12px;">'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);margin-bottom:4px;">BATTERY</div>'+
            '<div style="font-size:15px;font-weight:800;color:var(--text,#f1f5f9);">'+(b0.units||1)+' × '+friendlyBat+'</div>'+
          '</div>'+
          '<div style="background:rgba(255,255,255,0.05);border-radius:10px;padding:12px;">'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);margin-bottom:4px;">SOLAR PANELS</div>'+
            '<div style="font-size:15px;font-weight:800;color:var(--text,#f1f5f9);">'+s.panels+' × Solar Panel (550W)</div>'+
          '</div>'+
          '<div style="background:rgba(255,255,255,0.05);border-radius:10px;padding:12px;">'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);margin-bottom:4px;">BACKUP TIME</div>'+
            '<div style="font-size:15px;font-weight:800;color:var(--text,#f1f5f9);">~'+backupHrs+'hrs without sun</div>'+
          '</div>'+
        '</div>'+
        '<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:14px;">'+
          '<div style="text-align:center;background:rgba(34,197,94,0.1);border-radius:8px;padding:8px;">'+
            '<div style="font-size:18px;font-weight:900;color:#22c55e;">'+coveragePct+'%</div>'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);">solar cover</div>'+
          '</div>'+
          '<div style="text-align:center;background:rgba(56,189,248,0.1);border-radius:8px;padding:8px;">'+
            '<div style="font-size:18px;font-weight:900;color:#38bdf8;">'+s.panels+'</div>'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);">panels needed</div>'+
          '</div>'+
          '<div style="text-align:center;background:rgba(167,139,250,0.1);border-radius:8px;padding:8px;">'+
            '<div style="font-size:18px;font-weight:900;color:#a78bfa;">'+(s.dw/1000).toFixed(1)+'</div>'+
            '<div style="font-size:10px;color:var(--muted,#94a3b8);">kWh/day</div>'+
          '</div>'+
        '</div>'+
        '<div style="background:rgba(245,158,11,0.1);border-radius:10px;padding:12px;text-align:center;">'+
          '<div style="font-size:11px;color:var(--muted,#94a3b8);margin-bottom:4px;">ESTIMATED EQUIPMENT COST</div>'+
          '<div style="font-size:22px;font-weight:900;color:var(--sun,#f59e0b);">'+fmtM(priceLow)+' – '+fmtM(priceHigh)+'</div>'+
          '<div style="font-size:11px;color:var(--muted,#94a3b8);margin-top:4px;">Price varies by vendor & location · Get exact quotes below</div>'+
        '</div>'+
        '</div>';
    }
