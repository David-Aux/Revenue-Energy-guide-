...
(function(){
  ...
  window.showScreen = function(screenId){
    ...
    // Defensive: if _showScreen not captured yet, fall back to direct DOM manipulation
    let out;
    if (typeof _showScreen === 'function') {
      out = _showScreen.apply(this, arguments);
    } else {
      // Fallback: manually activate the screen
